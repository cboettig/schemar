...
#' @param warrantyPromise (WarrantyPromise or WarrantyPromise type.) The warranty promise(s) included in the offer.
#' @param buyer (Person type.) A sub property of participant. The participant/person/organization that bought the object.
...
#'
#' @return a list object corresponding to a schema:SellAction
#'
#' @export

 SellAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
