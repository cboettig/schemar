...
#' @param resultReview (Review type.) A sub property of result. The review that resulted in the performing of the action.
...
#'
#' @return a list object corresponding to a schema:ReviewAction
#'
#' @export

 ReviewAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
