...
#' @param parentItem (Question type.) The parent of a question, answer or item in general.
...
#'
#' @return a list object corresponding to a schema:Answer
#'
#' @export

 Answer <- function(id = NULL,
upvoteCount = NULL,
 parentItem = NULL,
 downvoteCount = NULL,
 workExample = NULL,
