...
#' @param workPresented (Movie type.) The movie presented during this event.
...
#'
#' @return a list object corresponding to a schema:ScreeningEvent
#'
#' @export

 ScreeningEvent <- function(id = NULL,
workPerformed = NULL,
 workFeatured = NULL,
