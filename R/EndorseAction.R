...
#' @param endorsee (Person or Organization type.) A sub property of participant. The person/organization being supported.
...
#'
#' @return a list object corresponding to a schema:EndorseAction
#'
#' @export

 EndorseAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
