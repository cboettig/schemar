...
#' @param liveBlogUpdate (BlogPosting type.) An update to the LiveBlog.
#' @param coverageStartTime (DateTime type.) The time when the live blog will begin covering the Event. Note that coverage may begin before the Event's start time. The LiveBlogPosting may also be created before coverage begins.
#' @param coverageEndTime (DateTime type.) The time when the live blog will stop covering the Event. Note that coverage may continue after the Event concludes.
#' @param sharedContent (CreativeWork type.) A CreativeWork such as an image, video, or audio clip shared as part of this posting.
...
#'
#' @return a list object corresponding to a schema:LiveBlogPosting
#'
#' @export

 LiveBlogPosting <- function(id = NULL,
wordCount = NULL,
 pagination = NULL,
 pageStart = NULL,
 pageEnd = NULL,
