...
#' @param seatingType (Text or QualitativeValue type.) The type/class of the seat.
#' @param seatSection (Text type.) The section location of the reserved seat (e.g. Orchestra).
#' @param seatRow (Text type.) The row location of the reserved seat (e.g., B).
#' @param seatNumber (Text type.) The location of the reserved seat (e.g., 27).
...
#'
#' @return a list object corresponding to a schema:Seat
#'
#' @export

 Seat <- function(id = NULL,
seatingType = NULL,
 seatSection = NULL,
 seatRow = NULL,
 seatNumber = NULL,
