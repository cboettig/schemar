...
#' @param claimReviewed (Text type.) A short summary of the specific claims reviewed in a ClaimReview.
...
#' @param reviewRating (Rating type.) The rating given in this review. Note that reviews can themselves be rated. The ```reviewRating``` applies to rating given by the review. The [[aggregateRating]] property applies to the review itself, as a creative work.
#' @param reviewBody (Text type.) The actual body of the review.
...
#'
#' @return a list object corresponding to a schema:ClaimReview
#'
#' @export

 ClaimReview <- function(id = NULL,
claimReviewed = NULL,
 workExample = NULL,
 video = NULL,
 version = NULL,
