...
#' @param representativeOfPage (Boolean type.) Indicates whether this image is representative of the content of the page.
#' @param exifData (Text or PropertyValue type.) exif data for this object.
...
#'
#' @return a list object corresponding to a schema:ImageObject
#'
#' @export

 ImageObject <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
