...
#' @param departureBusStop (BusStop or BusStation type.) The stop or station from which the bus departs.
#' @param busNumber (Text type.) The unique identifier for the bus.
#' @param busName (Text type.) The name of the bus (e.g. Bolt Express).
#' @param arrivalBusStop (BusStop or BusStation type.) The stop or station from which the bus arrives.
...
#'
#' @return a list object corresponding to a schema:BusTrip
#'
#' @export

 BusTrip <- function(id = NULL,
