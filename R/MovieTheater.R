...
#' @param screenCount (Number type.) The number of screens in the movie theater.
...
#'
#' @return a list object corresponding to a schema:MovieTheater
#'
#' @export

 MovieTheater <- function(id = NULL,
priceRange = NULL,
