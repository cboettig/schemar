...
#' @param seasonNumber (Text or Integer type.) Position of the season within an ordered group of seasons.
...
#'
#' @return a list object corresponding to a schema:TVSeason
#'
#' @export

 TVSeason <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
