...
#' @param partOfSeries (CreativeWorkSeries or CreativeWorkSeries or CreativeWorkSeries type.) The series to which this episode or season belongs.
#' @param partOfSeason (CreativeWorkSeason or CreativeWorkSeason type.) The season to which this episode belongs.
...
#' @param episodeNumber (Text or Integer type.) Position of the episode within an ordered group of episodes.
...
#' @param subtitleLanguage (Text or Language or Text or Language or Text or Language type.) Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
#' @param partOfTVSeries (TVSeries or TVSeries or TVSeries type.) The TV series to which this episode or season belongs.
#' @param countryOfOrigin (Country or Country or Country or Country type.) The country of the principal offices of the production company or individual responsible for the movie or program.
#'
#' @return a list object corresponding to a schema:TVEpisode
#'
#' @export

 TVEpisode <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
