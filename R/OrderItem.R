...
#' @param orderQuantity (Number type.) The number of the item ordered. If the property is not set, assume the quantity is one.
#' @param orderItemStatus (OrderStatus type.) The current status of the order item.
#' @param orderItemNumber (Text type.) The identifier of the order item.
...
#'
#' @return a list object corresponding to a schema:OrderItem
#'
#' @export

 OrderItem <- function(id = NULL,
orderedItem = NULL,
 orderQuantity = NULL,
