...
#' @param reviewCount (Integer type.) The count of total number of reviews.
#' @param ratingCount (Integer type.) The count of total number of ratings.
#' @param itemReviewed (Thing or Thing type.) The item that is being reviewed/rated.
#' @param worstRating (Text or Number type.) The lowest value allowed in this rating system. If worstRating is omitted, 1 is assumed.
#' @param ratingValue (Text or Number type.) The rating for the content.
#' @param bestRating (Text or Number type.) The highest value allowed in this rating system. If bestRating is omitted, 5 is assumed.
...
#'
#' @return a list object corresponding to a schema:AggregateRating
#'
#' @export

 AggregateRating <- function(id = NULL,
reviewCount = NULL,
 ratingCount = NULL,
 itemReviewed = NULL,
 worstRating = NULL,
