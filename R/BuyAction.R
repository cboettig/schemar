...
#' @param vendor (Person or Organization type.) 'vendor' is an earlier term for 'seller'.
...
#'
#' @return a list object corresponding to a schema:BuyAction
#'
#' @export

 BuyAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
