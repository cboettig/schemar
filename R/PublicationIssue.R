#' PublicationIssue 
#'
#' A part of a successively published publication such as a periodical or publication volume, often numbered, usually containing a grouping of works such as articles.[blog post](http://blog.schema.org/2014/09/schemaorg-support-for-bibliographic_2.html). 
#'
#'
...
#' @param issueNumber (Text or Integer type.) Identifies the issue of publication; for example, "iii" or "2".
...
#'
#' @return a list object corresponding to a schema:PublicationIssue
#'
#' @export

 PublicationIssue <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
