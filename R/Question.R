...
#' @param upvoteCount (Integer or Integer type.) The number of upvotes this question, answer or comment has received from the community.
#' @param suggestedAnswer (ItemList or Answer type.) An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
#' @param downvoteCount (Integer or Integer type.) The number of downvotes this question, answer or comment has received from the community.
#' @param answerCount (Integer type.) The number of answers this question has received.
#' @param acceptedAnswer (ItemList or Answer type.) The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
...
#'
#' @return a list object corresponding to a schema:Question
#'
#' @export

 Question <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
