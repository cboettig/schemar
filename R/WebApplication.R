...
#' @param browserRequirements (Text type.) Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
#'
#' @return a list object corresponding to a schema:WebApplication
#'
#' @export

 WebApplication <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
