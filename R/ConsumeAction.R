...
#' @param expectsAcceptanceOf (Offer type.) An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it.
...
#'
#' @return a list object corresponding to a schema:ConsumeAction
#'
#' @export

 ConsumeAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
