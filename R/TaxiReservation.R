...
#' @param partySize (QuantitativeValue or Integer or QuantitativeValue or Integer type.) Number of people the reservation should accommodate.
...
#'
#' @return a list object corresponding to a schema:TaxiReservation
#'
#' @export

 TaxiReservation <- function(id = NULL,
underName = NULL,
 totalPrice = NULL,
 reservedTicket = NULL,
