...
#' @param deliveryMethod (DeliveryMethod or DeliveryMethod or DeliveryMethod or DeliveryMethod type.) A sub property of instrument. The method of delivery.
...
#'
#' @return a list object corresponding to a schema:ReceiveAction
#'
#' @export

 ReceiveAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
