...
#' @param requiredQuantity (Text or QuantitativeValue or Number type.) The required quantity of the item(s).
...
#'
#' @return a list object corresponding to a schema:HowToSupply
#'
#' @export

 HowToSupply <- function(id = NULL,
