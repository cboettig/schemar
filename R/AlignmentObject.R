...
#' @param targetUrl (URL type.) The URL of a node in an established educational framework.
#' @param targetName (Text type.) The name of a node in an established educational framework.
#' @param targetDescription (Text type.) The description of a node in an established educational framework.
#' @param educationalFramework (Text type.) The framework to which the resource being described is aligned.
#' @param alignmentType (Text type.) A category of alignment between the learning resource and the framework node. Recommended values include: 'assesses', 'teaches', 'requires', 'textComplexity', 'readingLevel', 'educationalSubject', and 'educationalLevel'.
...
#'
#' @return a list object corresponding to a schema:AlignmentObject
#'
#' @export

 AlignmentObject <- function(id = NULL,
targetUrl = NULL,
 targetName = NULL,
