...
#' @param recordingOf (MusicComposition type.) The composition this track is a recording of.
#' @param isrcCode (Text type.) The International Standard Recording Code for the recording.
#' @param inPlaylist (MusicPlaylist type.) The playlist to which this recording belongs.
#' @param inAlbum (MusicAlbum type.) The album to which this recording belongs.
...
#'
#' @return a list object corresponding to a schema:MusicRecording
#'
#' @export

 MusicRecording <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
