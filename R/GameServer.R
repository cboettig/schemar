...
#' @param serverStatus (GameServerStatus type.) Status of a game server.
#' @param playersOnline (Integer type.) Number of players on the server.
#' @param game (VideoGame type.) Video game which is played on this server.
...
#'
#' @return a list object corresponding to a schema:GameServer
#'
#' @export

 GameServer <- function(id = NULL,
serverStatus = NULL,
 playersOnline = NULL,
 game = NULL,
 url = NULL,
