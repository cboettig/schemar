...
#' @param dataFeedElement (Thing or Text or DataFeedItem type.) An item within in a data feed. Data feeds may have many elements.
#' @param temporal (DateTime type.) The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
#' @param spatial (Place type.) The range of spatial applicability of a dataset, e.g. for a dataset of New York weather, the state of New York.
...
#' @param includedInDataCatalog (DataCatalog type.) A data catalog which contains this dataset.
#' @param includedDataCatalog (DataCatalog type.) A data catalog which contains this dataset (this property was previously 'catalog', preferred name is now 'includedInDataCatalog').
#' @param distribution (DataDownload type.) A downloadable form of this dataset, at a specific location, in a specific format.
#' @param datasetTimeInterval (DateTime type.) The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
#' @param catalog (DataCatalog type.) A data catalog which contains this dataset.
...
#'
#' @return a list object corresponding to a schema:DataFeed
#'
#' @export

 DataFeed <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
