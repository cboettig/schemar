...
#' @param partOfEpisode (Episode type.) The episode to which this clip belongs.
...
#' @param clipNumber (Text or Integer type.) Position of the clip within an ordered group of clips.
...
#'
#' @return a list object corresponding to a schema:TVClip
#'
#' @export

 TVClip <- function(id = NULL,
partOfSeries = NULL,
 partOfSeason = NULL,
 partOfEpisode = NULL,
 musicBy = NULL,
