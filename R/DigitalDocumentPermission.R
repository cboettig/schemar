...
#' @param permissionType (DigitalDocumentPermissionType type.) The type of permission granted the person, organization, or audience.
#' @param grantee (Person or Organization or ContactPoint or Audience type.) The person, organization, contact point, or audience that has been granted this permission.
...
#'
#' @return a list object corresponding to a schema:DigitalDocumentPermission
#'
#' @export

 DigitalDocumentPermission <- function(id = NULL,
permissionType = NULL,
 grantee = NULL,
 url = NULL,
 sameAs = NULL,
