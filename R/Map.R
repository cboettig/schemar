...
#' @param mapType (MapCategoryType type.) Indicates the kind of Map, from the MapCategoryType Enumeration.
...
#'
#' @return a list object corresponding to a schema:Map
#'
#' @export

 Map <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
