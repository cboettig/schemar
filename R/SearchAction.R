...
#' @param query (Text type.) A sub property of instrument. The query used on this action.
...
#'
#' @return a list object corresponding to a schema:SearchAction
#'
#' @export

 SearchAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
