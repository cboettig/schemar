...
#' @param borrower (Person type.) A sub property of participant. The person that borrows the object being lent.
...
#'
#' @return a list object corresponding to a schema:LendAction
#'
#' @export

 LendAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
