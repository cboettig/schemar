...
#' @param icaoCode (Text type.) ICAO identifier for an airport.
#' @param iataCode (Text or Text type.) IATA identifier for an airline or airport.
...
#'
#' @return a list object corresponding to a schema:Airport
#'
#' @export

 Airport <- function(id = NULL,
icaoCode = NULL,
 iataCode = NULL,
 openingHours = NULL,
 telephone = NULL,
