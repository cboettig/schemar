...
#' @param carrierRequirements (Text type.) Specifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network).
...
#'
#' @return a list object corresponding to a schema:MobileApplication
#'
#' @export

 MobileApplication <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
