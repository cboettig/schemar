...
#' @param realEstateAgent (RealEstateAgent type.) A sub property of participant. The real estate agent involved in the action.
#' @param landlord (Person or Organization type.) A sub property of participant. The owner of the real estate property.
...
#'
#' @return a list object corresponding to a schema:RentAction
#'
#' @export

 RentAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
