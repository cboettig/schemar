...
#' @param offerCount (Integer type.) The number of offers for the product.
#' @param lowPrice (Text or Number type.) The lowest price of all offers available.
#' @param highPrice (Text or Number type.) The highest price of all offers available.
...
#'
#' @return a list object corresponding to a schema:AggregateOffer
#'
#' @export

 AggregateOffer <- function(id = NULL,
offers = NULL,
 offerCount = NULL,
 lowPrice = NULL,
 highPrice = NULL,
