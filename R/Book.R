...
#' @param numberOfPages (Integer type.) The number of pages in the book.
#' @param isbn (Text type.) The ISBN of the book.
#' @param illustrator (Person type.) The illustrator of the book.
#' @param bookFormat (BookFormatType type.) The format of the book.
#' @param bookEdition (Text type.) The edition of the book.
...
#'
#' @return a list object corresponding to a schema:Book
#'
#' @export

 Book <- function(id = NULL,
numberOfPages = NULL,
 isbn = NULL,
 illustrator = NULL,
 bookFormat = NULL,
