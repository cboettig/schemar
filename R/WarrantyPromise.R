...
#' @param warrantyScope (WarrantyScope type.) The scope of the warranty promise.
#' @param durationOfWarranty (QuantitativeValue type.) The duration of the warranty promise. Common unitCode values are ANN for year, MON for months, or DAY for days.
#'
#' @return a list object corresponding to a schema:WarrantyPromise
#'
#' @export

 WarrantyPromise <- function(id = NULL,
url = NULL,
 sameAs = NULL,
