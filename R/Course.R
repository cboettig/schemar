...
#' @param hasCourseInstance (CourseInstance type.) An offering of the course at a specific time and place or through specific media or mode of study or to a specific section of students.
#' @param coursePrerequisites (Text or Course or AlignmentObject type.) Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
#' @param courseCode (Text type.) The identifier for the [[Course]] used by the course [[provider]] (e.g. CS101 or 6.001).
...
#'
#' @return a list object corresponding to a schema:Course
#'
#' @export

 Course <- function(id = NULL,
