...
#' @param childMinAge (Number type.) Minimal age of the child.
#' @param childMaxAge (Number type.) Maximal age of the child.
#' @param suggestedMinAge (Number type.) Minimal age recommended for viewing content.
#' @param suggestedMaxAge (Number type.) Maximal age recommended for viewing content.
#' @param suggestedGender (Text type.) The gender of the person or audience.
#' @param requiredMinAge (Integer type.) Audiences defined by a person's minimum age.
#' @param requiredMaxAge (Integer type.) Audiences defined by a person's maximum age.
#' @param requiredGender (Text type.) Audiences defined by a person's gender.
...
#'
#' @return a list object corresponding to a schema:ParentAudience
#'
#' @export

 ParentAudience <- function(id = NULL,
geographicArea = NULL,
 audienceType = NULL,
 childMinAge = NULL,
 childMaxAge = NULL,
