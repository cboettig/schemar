...
#' @param sport (URL or Text type.) A type of sport (e.g. Baseball).
#' @param coach (Person type.) A person that acts in a coaching role for a sports team.
#' @param athlete (Person type.) A person that acts as performing member of a sports team; a player as opposed to a coach.
...
#'
#' @return a list object corresponding to a schema:SportsTeam
#'
#' @export

 SportsTeam <- function(id = NULL,
vatID = NULL,
 telephone = NULL,
 taxID = NULL,
