...
#' @param homeTeam (SportsTeam or Person type.) The home team in a sports event.
#' @param competitor (SportsTeam or Person type.) A competitor in a sports event.
#' @param awayTeam (SportsTeam or Person type.) The away team in a sports event.
...
#'
#' @return a list object corresponding to a schema:SportsEvent
#'
#' @export

 SportsEvent <- function(id = NULL,
workPerformed = NULL,
 workFeatured = NULL,
