...
#' @param priceComponent (UnitPriceSpecification type.) This property links to all [[UnitPriceSpecification]] nodes that apply in parallel for the [[CompoundPriceSpecification]] node.
...
#'
#' @return a list object corresponding to a schema:CompoundPriceSpecification
#'
#' @export

 CompoundPriceSpecification <- function(id = NULL,
priceComponent = NULL,
