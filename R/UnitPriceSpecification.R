...
#' @param referenceQuantity (QuantitativeValue type.) The reference quantity for which a certain price applies, e.g. 1 EUR per 4 kWh of electricity. This property is a replacement for unitOfMeasurement for the advanced cases where the price does not relate to a standard unit.
#' @param priceType (Text type.) A short text or acronym indicating multiple price specifications for the same offer, e.g. SRP for the suggested retail price or INVOICE for the invoice price, mostly used in the car industry.
#' @param billingIncrement (Number type.) This property specifies the minimal quantity and rounding increment that will be the basis for the billing. The unit of measurement is specified by the unitCode property.
#'
#' @return a list object corresponding to a schema:UnitPriceSpecification
#'
#' @export

 UnitPriceSpecification <- function(id = NULL,
