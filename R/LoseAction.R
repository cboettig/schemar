...
#' @param winner (Person type.) A sub property of participant. The winner of the action.
...
#'
#' @return a list object corresponding to a schema:LoseAction
#'
#' @export

 LoseAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
