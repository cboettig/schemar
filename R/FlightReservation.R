...
#' @param securityScreening (Text type.) The type of security screening the passenger is subject to.
#' @param passengerSequenceNumber (Text type.) The passenger's sequence number as assigned by the airline.
#' @param passengerPriorityStatus (Text or QualitativeValue type.) The priority status assigned to a passenger for security or boarding (e.g. FastTrack or Priority).
#' @param boardingGroup (Text type.) The airline-specific indicator of boarding order / preference.
...
#'
#' @return a list object corresponding to a schema:FlightReservation
#'
#' @export

 FlightReservation <- function(id = NULL,
