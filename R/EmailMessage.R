...
#' @param toRecipient (Person or Organization or ContactPoint or Audience type.) A sub property of recipient. The recipient who was directly sent the message.
#' @param sender (Person or Organization or Audience or Person or Organization or Audience type.) A sub property of participant. The participant who is at the sending end of the action.
...
#' @param messageAttachment (CreativeWork type.) A CreativeWork attached to the message.
#' @param dateSent (DateTime type.) The date/time at which the message was sent.
#' @param dateReceived (DateTime type.) The date/time the message was received if a single recipient exists.
#' @param dateRead (DateTime type.) The date/time at which the message has been read by the recipient if a single recipient exists.
#' @param ccRecipient (Person or Organization or ContactPoint type.) A sub property of recipient. The recipient copied on a message.
#' @param bccRecipient (Person or Organization or ContactPoint type.) A sub property of recipient. The recipient blind copied on a message.
...
#'
#' @return a list object corresponding to a schema:EmailMessage
#'
#' @export

 EmailMessage <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
