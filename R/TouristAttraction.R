...
#' @param touristType (Text or Audience type.) Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc.
...
#'
#' @return a list object corresponding to a schema:TouristAttraction
#'
#' @export

 TouristAttraction <- function(id = NULL,
telephone = NULL,
