...
#' @param educationalRole (Text type.) An educationalRole of an EducationalAudience.
...
#'
#' @return a list object corresponding to a schema:EducationalAudience
#'
#' @export

 EducationalAudience <- function(id = NULL,
geographicArea = NULL,
 audienceType = NULL,
