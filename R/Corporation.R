...
#' @param tickerSymbol (Text type.) The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO15022.
...
#'
#' @return a list object corresponding to a schema:Corporation
#'
#' @export

 Corporation <- function(id = NULL,
tickerSymbol = NULL,
 vatID = NULL,
 telephone = NULL,
 taxID = NULL,
