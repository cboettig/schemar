...
#' @param blogPosts (BlogPosting type.) The postings that are part of this blog.
#' @param blogPost (BlogPosting type.) A posting that is part of this blog.
...
#'
#' @return a list object corresponding to a schema:Blog
#'
#' @export

 Blog <- function(id = NULL,
issn = NULL,
 blogPosts = NULL,
 blogPost = NULL,
 workExample = NULL,
