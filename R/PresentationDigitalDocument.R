...
#' @param hasDigitalDocumentPermission (DigitalDocumentPermission type.) A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".
...
#'
#' @return a list object corresponding to a schema:PresentationDigitalDocument
#'
#' @export

 PresentationDigitalDocument <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
 ...
 accessMode = NULL,
 about = NULL,
 hasDigitalDocumentPermission = NULL,
 url = NULL,
 sameAs = NULL,
