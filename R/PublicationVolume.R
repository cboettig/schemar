...
#' @param volumeNumber (Text or Integer type.) Identifies the volume of publication or multi-part work; for example, "iii" or "2".
...
#'
#' @return a list object corresponding to a schema:PublicationVolume
#'
#' @export

 PublicationVolume <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
