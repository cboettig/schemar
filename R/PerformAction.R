...
#' @param entertainmentBusiness (EntertainmentBusiness type.) A sub property of location. The entertainment business where the action occurred.
...
#'
#' @return a list object corresponding to a schema:PerformAction
#'
#' @export

 PerformAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
