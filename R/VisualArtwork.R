...
#' @param surface (URL or Text type.) A material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc.
...
#' @param artworkSurface (URL or Text type.) The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
#' @param artform (URL or Text type.) e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
#' @param artMedium (URL or Text type.) The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
#' @param artEdition (Text or Integer type.) The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
#'
#' @return a list object corresponding to a schema:VisualArtwork
#'
#' @export

 VisualArtwork <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
