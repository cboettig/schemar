...
#' @param reportNumber (Text type.) The number or other unique designator assigned to a Report by the publishing organization.
...
#'
#' @return a list object corresponding to a schema:Report
#'
#' @export
