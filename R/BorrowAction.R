...
#' @param lender (Person or Organization type.) A sub property of participant. The person that lends the object being borrowed.
...
#'
#' @return a list object corresponding to a schema:BorrowAction
#'
#' @export

 BorrowAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
