...
#' @param replacer (Thing type.) A sub property of object. The object that replaces.
#' @param replacee (Thing type.) A sub property of object. The object that is being replaced.
...
#' @param targetCollection (Thing type.) A sub property of object. The collection target of the action.
#' @param collection (Thing type.) A sub property of object. The collection target of the action.
#'
#' @return a list object corresponding to a schema:ReplaceAction
#'
#' @export

 ReplaceAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
