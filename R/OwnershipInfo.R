...
#' @param ownedThrough (DateTime type.) The date and time of giving up ownership on the product.
#' @param ownedFrom (DateTime type.) The date and time of obtaining the product.
#' @param acquiredFrom (Person or Organization type.) The organization or person from which the product was acquired.
...
#'
#' @return a list object corresponding to a schema:OwnershipInfo
#'
#' @export

 OwnershipInfo <- function(id = NULL,
typeOfGood = NULL,
 ownedThrough = NULL,
 ownedFrom = NULL,
 acquiredFrom = NULL,
