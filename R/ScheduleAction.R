...
#' @param scheduledTime (DateTime type.) The time the object is scheduled to.
...
#'
#' @return a list object corresponding to a schema:ScheduleAction
#'
#' @export

 ScheduleAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
