...
#' @param loser (Person type.) A sub property of participant. The loser of the action.
#'
#' @return a list object corresponding to a schema:WinAction
#'
#' @export

 WinAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
