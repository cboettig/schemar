...
#' @param resultComment (Comment or Comment type.) A sub property of result. The Comment created or sent as a result of this action.
...
#'
#' @return a list object corresponding to a schema:CommentAction
#'
#' @export

 CommentAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
