...
#' @param recipe (Recipe type.) A sub property of instrument. The recipe/instructions used to perform the action.
#' @param foodEvent (FoodEvent type.) A sub property of location. The specific food event where the action occurred.
#' @param foodEstablishment (Place or FoodEstablishment type.) A sub property of location. The specific food establishment where the action occurred.
...
#'
#' @return a list object corresponding to a schema:CookAction
#'
#' @export

 CookAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
