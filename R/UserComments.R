...
#' @param replyToUrl (URL type.) The URL at which a reply may be posted to the specified UserComment.
#' @param discusses (CreativeWork type.) Specifies the CreativeWork associated with the UserComment.
...
#' @param commentTime (DateTime or Date type.) The time at which the UserComment was made.
#' @param commentText (Text type.) The text of the UserComment.
#'
#' @return a list object corresponding to a schema:UserComments
#'
#' @export

 UserComments <- function(id = NULL,
workPerformed = NULL,
 workFeatured = NULL,
