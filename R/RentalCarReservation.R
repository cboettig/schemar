...
#' @param pickupTime (DateTime or DateTime type.) When a taxi will pickup a passenger or a rental car can be picked up.
#' @param pickupLocation (Place or Place type.) Where a taxi will pick up a passenger or a rental car can be picked up.
#' @param dropoffTime (DateTime type.) When a rental car can be dropped off.
#' @param dropoffLocation (Place type.) Where a rental car can be dropped off.
...
#'
#' @return a list object corresponding to a schema:RentalCarReservation
#'
#' @export

 RentalCarReservation <- function(id = NULL,
pickupTime = NULL,
 pickupLocation = NULL,
 dropoffTime = NULL,
