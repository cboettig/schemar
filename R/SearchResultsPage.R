...
#' @param specialty (Specialty type.) One of the domain specialities to which this web page's content applies.
#' @param significantLinks (URL type.) The most significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
#' @param significantLink (URL type.) One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
#' @param reviewedBy (Person or Organization type.) People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
#' @param relatedLink (URL type.) A link related to this web page, for example to other related web pages.
#' @param primaryImageOfPage (ImageObject type.) Indicates the main image on the page.
#' @param mainContentOfPage (WebPageElement type.) Indicates if this web page element is the main subject of the page.
#' @param lastReviewed (Date type.) Date on which the content on this web page was last reviewed for accuracy and/or completeness.
#' @param breadcrumb (Text or BreadcrumbList type.) A set of links that can help a user understand and navigate a website hierarchy.
#'
#' @return a list object corresponding to a schema:SearchResultsPage
#'
#' @export

 SearchResultsPage <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
