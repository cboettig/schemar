...
#' @param byArtist (MusicGroup or MusicGroup type.) The artist that performed this album or recording.
#' @param albumReleaseType (MusicAlbumReleaseType type.) The kind of release which this album is: single, EP or album.
#' @param albumRelease (MusicRelease type.) A release of this album.
#' @param albumProductionType (MusicAlbumProductionType type.) Classification of the album by it's type of content: soundtrack, live album, studio album, etc.
...
#'
#' @return a list object corresponding to a schema:MusicAlbum
#'
#' @export

 MusicAlbum <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
