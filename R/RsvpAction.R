...
#' @param language (Language or Language type.) A sub property of instrument. The language used on this action.
...
#' @param rsvpResponse (RsvpResponseType type.) The response (yes, no, maybe) to the RSVP.
#' @param comment (Comment or Comment type.) Comments, typically from users.
#' @param additionalNumberOfGuests (Number type.) If responding yes, the number of guests who will attend in addition to the invitee.
...
#'
#' @return a list object corresponding to a schema:RsvpAction
#'
#' @export

 RsvpAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
