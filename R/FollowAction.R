...
#' @param followee (Person or Organization type.) A sub property of object. The person or organization being followed.
...
#'
#' @return a list object corresponding to a schema:FollowAction
#'
#' @export

 FollowAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
