...
#' @param option (Thing or Text type.) A sub property of object. The options subject to this action.
#' @param actionOption (Thing or Text type.) A sub property of object. The options subject to this action.
...
#' @param candidate (Person type.) A sub property of object. The candidate subject of this action.
#'
#' @return a list object corresponding to a schema:VoteAction
#'
#' @export

 VoteAction <- function(id = NULL,
target = NULL,
 startTime = NULL,
 result = NULL,
 participant = NULL,
