...
#' @param instructor (Person type.) A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
#' @param courseMode (URL or Text type.) The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
...
#'
#' @return a list object corresponding to a schema:CourseInstance
#'
#' @export

 CourseInstance <- function(id = NULL,
instructor = NULL,
 courseMode = NULL,
 workPerformed = NULL,
 workFeatured = NULL,
