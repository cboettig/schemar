...
#' @param targetProduct (SoftwareApplication type.) Target Operating System / Product to which the code applies.  If applies to several versions, just the product name can be used.
#' @param sampleType (Text type.) What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
#' @param runtimePlatform (Text type.) Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
#' @param runtime (Text type.) Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
#' @param programmingLanguage (Text or ComputerLanguage type.) The computer programming language.
#' @param codeSampleType (Text type.) What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
#' @param codeRepository (URL type.) Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
...
#'
#' @return a list object corresponding to a schema:SoftwareSourceCode
#'
#' @export

 SoftwareSourceCode <- function(id = NULL,
workExample = NULL,
 video = NULL,
 version = NULL,
