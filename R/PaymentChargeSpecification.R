...
#' @param appliesToPaymentMethod (PaymentMethod type.) The payment method(s) to which the payment charge specification applies.
...
#'
#' @return a list object corresponding to a schema:PaymentChargeSpecification
#'
#' @export

 PaymentChargeSpecification <- function(id = NULL,
