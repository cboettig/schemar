...
#' @param targetPlatform (Text type.) Type of app development: phone, Metro style, desktop, XBox, etc.
#' @param programmingModel (Text type.) Indicates whether API is managed or unmanaged.
#' @param executableLibraryName (Text type.) Library file name e.g., mscorlib.dll, system.web.dll.
#' @param assemblyVersion (Text type.) Associated product/technology version. e.g., .NET Framework 4.5.
#' @param assembly (Text type.) Library file name e.g., mscorlib.dll, system.web.dll.
...
#' @param proficiencyLevel (Text type.) Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
#' @param dependencies (Text type.) Prerequisites needed to fulfill steps in article.
...
#'
#' @return a list object corresponding to a schema:APIReference
#'
#' @export

 APIReference <- function(id = NULL,
targetPlatform = NULL,
 programmingModel = NULL,
 executableLibraryName = NULL,
